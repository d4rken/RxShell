...
public class SuAppTest extends BaseTest {
    ...
    public void testDetection_infos() {
        ...
        final SuApp suApp = new SuApp.Builder(packageManager, suBinary).build().blockingGet();
        assertNotNull(suApp);
    ...
    public void testDetection_koush_superuser() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.koushikdutta.superuser"));
    }
    ...
    public void testDetection_chainsdd() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.noshufou.android.su"));
    }
    ...
    public void testDetection_kinguser() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.kingroot.kinguser"));
    }
    ...
    public void testDetection_vroot() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.mgyun.shua.su"));

        packageMap.clear();
        fakePackage("com.mgyun.superuser");
        when(suBinary.getType()).thenReturn(SuBinary.Type.VROOT);
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.mgyun.superuser"));
    }
    ...
    public void testDetection_venomsu() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.m0narx.su"));
    }
    ...
    public void testDetection_kingouser() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.kingouser.com"));
    }
    ...
    public void testDetection_miui() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.miui.uac"));

        packageMap.clear();
        fakePackage("com.lbe.security.miui");
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.lbe.security.miui"));
    }
    ...
    public void testDetection_cyanogen() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.android.settings"));
    }
    ...
    public void testDetection_qihoo360() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.qihoo.permmgr"));

        packageMap.clear();
        fakePackage("com.qihoo.permroot");
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.qihoo.permroot"));
    }
    ...
    public void testDetection_baiduEasyRoot() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.baidu.easyroot"));
    }
    ...
    public void testDetection_dianxinos() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.dianxinos.superuser"));
    }
    ...
    public void testDetection_baiyi() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.baiyi_mobile.easyroot"));
    }
    ...
    public void testDetection_tencentAppManager() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.tencent.qrom.appmanager"));
    }
    ...
    public void testDetection_seSuperUser() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("me.phh.superuser"));
    }
    ...
    public void testDetection_magisk() {
        ...
        assertThat(new SuApp.Builder(packageManager, suBinary).build().blockingGet().getPackageName(), is("com.topjohnwu.magisk"));
    }
